  ...
  >
    ...
    <div class="menu-items">
      ...
      <div
        ...
        @mouseenter="menucontrol(false)"
        @click = "menucontrol(false)"
      >
        <div>
          <router-link
            class="main-menu"
        ...
        <div class="mega-menu" v-if="isMegaMenu">
          <div class="supply-service">
            ...
            <div class="service">
              ...
              <div class="service-item">
                ...
                <div class="item pointer" @click="goRoute('erp-services')">
                  <img
                    :src="require('@/assets/images/icon/erp.png')"
                    alt=""
                  />
                  <div>Digital Business Solution</div>
                </div>

                <div class="item pointer" @click="goRoute('data-center-maintainance-services')">
                  <img
                    :src="require('@/assets/images/icon/ServerRental.png')"
                    alt=""
                  />
                ...
                <div class="item pointer" @click="goRoute('server-rental')">
                  <img
                    ...
                    alt=""
                  />
                  <div>Data Center Colocation</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="contact">
      <div class="contact-menu">
        ...
        <div class="ph-no">+65 9469 5626</div>
      </div>
